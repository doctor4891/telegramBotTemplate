...
namespace RedBeanPHP\Logger\RDefault {
    ...
    class Debug extends RDefault implements Logger
    {
         ...
         *
         * @param bool $yesNo CLI-override setting flag
         *
         * @return void
         */
...
namespace RedBeanPHP\Driver {
    ...
    class RPDO implements Driver
    {
         ...
         * </code>
         *
         * @param bool $retCol pass TRUE to return both charset/collate
         *
         * @return string|array
         */
        ...
        {
            if ($retCol) {
                return ['charset' => $this->mysqlCharset, 'collate' => $this->mysqlCollate];
            }
...
namespace RedBeanPHP {
    ...
    class OODBBean implements\IteratorAggregate, \ArrayAccess, \Countable, Jsonable
    {
         ...
         * a __toString-function).
         *
         * @param bool $toggle TRUE to enforce UTF-8 encoding (slower)
         *
         * @return void
         */
         ...
         * @return OODBBean
         */
        public function importFrom(self $sourceBean)
        {
            $this->__info['tainted'] = true;
            $this->__info['changed'] = true;
         ...
         * @return OODBBean
         */
        public function inject(self $otherBean)
        {
        ...
        public function __set($property, $value)
        {
            ...
            if (array_key_exists($fieldLink, $this->properties) && !($value instanceof self)) {
         ...
         * @return OODBBean
         */
        public function copyMetaFrom(self $bean)
        {
         ...
         * @return bool
         */
        public function equals(self $bean)
        {
            return (bool) (
...
namespace RedBeanPHP {
    ...
    interface QueryWriter
    {
         ...
         * @param bool   $alsoScanSpecialForTypes take special types into account
         *
         * @return int
         */
         ...
         * @return int
         */
        public function queryCountTagged($type, $tagList, $all = false, $addSql = '', $bindings = []);
         ...
         * @param int    $id       id of the reference row
         * @param bool   $up       TRUE to query parent rows, FALSE to query child rows
         * @param string $addSql   optional SQL snippet to embed in the query
         * @param array  $bindings parameter bindings for additional SQL snippet
         *
         * @return array
         */
        public function queryRecursiveCommonTableExpression($type, $id, $up = true, $addSql = null, $bindings = []);
    ...
    abstract class AQueryWriter
    {
        ...
        public function queryRecord($type, $conditions = [], $addSql = null, $bindings = [])
        {
            if ($this->flagUseCache && $this->sqlSelectSnippet != self::C_SELECT_SNIPPET_FOR_UPDATE) {
                $key = $this->getCacheKey([$conditions, trim("$addSql {$this->sqlSelectSnippet}"), $bindings, 'select']);
        ...
        public function queryRecordRelated($sourceType, $destType, $linkIDs, $addSql = '', $bindings = [])
        {
            ...
            if ($this->flagUseCache) {
                $key = $this->getCacheKey([$sourceType, implode(',', $linkIDs), trim($addSql), $bindings, 'selectrelated']);
        ...
        public function queryRecordLink($sourceType, $destType, $sourceID, $destID)
        {
            ...
            if ($this->flagUseCache) {
                $key = $this->getCacheKey([$sourceType, $destType, $sourceID, $destID, 'selectlink']);
         ...
         * @return array
         */
        private function queryTaggedGeneric($type, $tagList, $all = false, $addSql = '', $bindings = [], $wrap = '%s')
        {
            if ($this->flagUseCache) {
                $key = $this->getCacheKey([implode(',', $tagList), $all, trim($addSql), $bindings, 'selectTagged']);
                if ($cached = $this->getCached($type, $key)) {
                    return $cached;
                }
            }
        ...
        {
            if ($this->flagUseCache) {
                $key = $this->getCacheKey([$conditions, trim($addSql), $bindings, 'count']);
                if ($cached = $this->getCached($type, $key)) {
                    return $cached;
                }
            }
        ...
        public function queryRecordCountRelated($sourceType, $destType, $linkID, $addSql = '', $bindings = [])
        {
            ...
            if ($this->flagUseCache) {
                ...
                $key = $this->getCacheKey([$sourceType, $destType, $linkID, trim($addSql), $bindings, 'countrelated']);
...
namespace RedBeanPHP {
     ...
     */
         ...
         *
         * @param bool|array $yesNoBeans List of type names or 'all'
         *
         * @return mixed
         */
        ...
        public function count($type, $addSQL = '', $bindings = [])
        {
            ...
            try {
                $count = (int) $this->writer->queryRecordCount($type, [], $addSQL, $bindings);
            } catch (SQLException $exception) {
                $this->handleException($exception);
                $count = 0;
            }
        ...
        public function trash($bean)
        {
            ...
            try {
                $deleted = $this->writer->deleteRecord($bean->getMeta('type'), ['id' => [$bean->id]], null);
            } catch (SQLException $exception) {
                $this->handleException($exception);
            }
            $bean->id = 0;
        ...
        public function wipe($type)
        {
            try {
                ...
                if (!$this->writer->sqlStateIn($exception->getSQLState(), [QueryWriter::C_SQLSTATE_NO_SUCH_TABLE], $exception->getDriverDetails())) {
                    throw $exception;
                }
...
namespace RedBeanPHP {
    ...
    class Finder
    {
         ...
         * @return array
         */
        public function findLike($type, $conditions = [], $sql = '', $bindings = [])
        {
         ...
         * @return array
         */
        public function findMulti($types, $sql = null, $bindings = [], $remappings = [], $queryTemplate = ' %s.%s AS %s__%s')
        {
            if (!is_array($types)) {
...
namespace RedBeanPHP {
    ...
    class TagManager
    {
         ...
         * @return int
         */
        public function countTaggedAll($beanType, $tagList, $sql = '', $bindings = [])
        {
            $tags = $this->extractTagsIfNeeded($tagList);
         ...
         * @return int
         */
        public function countTagged($beanType, $tagList, $sql = '', $bindings = [])
        {
            $tags = $this->extractTagsIfNeeded($tagList);
...
namespace RedBeanPHP {
    ...
    class Facade
    {
            ...
            if (!self::$redbean->isFrozen()) {
                try {
                    ...
                    if (self::$writer->sqlStateIn($exception->getSQLState(),
                        [
                            QueryWriter::C_SQLSTATE_NO_SUCH_COLUMN,
                            QueryWriter::C_SQLSTATE_NO_SUCH_TABLE, ], $exception->getDriverDetails()
                    )
                    ) {
         ...
         *
         * @param bool $mode allow fluid transaction mode
         *
         * @return void
         */
         ...
         * certain types (i.e. tables) aren't touched.
         *
         * @param bool|array $tf mode of operation (TRUE means frozen)
         */
         ...
         * @return OODBBean
         */
        public static function findForUpdate($type, $sql, $bindings = [])
        {
         ...
         * @return array
         */
        public static function find($type, $sql = null, $bindings = [], $snippet = null)
        {
            if ($snippet !== null) {
                self::$writer->setSQLSelectSnippet($snippet);
            }
         ...
         * @return int
         */
        public static function countTaggedAll($beanType, $tagList, $sql = '', $bindings = [])
        {
         ...
         * @return int
         */
        public static function countTagged($beanType, $tagList, $sql = '', $bindings = [])
        {
         ...
         * @return array
         */
        public static function findLike($type, $like = [], $sql = '', $bindings = [])
        {
         ...
         * @param bool   $output   TRUE to output CSV directly using readfile
         ...
         * @return mixed
         */
        public static function matchUp($type, $sql, $bindings = [], $onFoundDo = null, $onNotFoundDo = null, &$bean = null)
        {
         ...
         * @return string
         */
        public static function look($sql, $bindings = [], $keys = ['selected', 'id', 'name'], $template = '<option %s value="%s">%s</option>', $filter = 'trim', $glue = '')
        {
         ...
         * @return array
         */
        public static function diff($bean, $other, $filters = ['created', 'modified'], $pattern = '%s.%s.%s')
        {
         ...
         *
         * @param bool $flag feature flag (either TRUE or FALSE)
         *
         * @return void
         */
         ...
         */
        public static function children(OODBBean $bean, $sql = null, $bindings = [])
        {
         ...
         * @param array    $bindings SQL snippet parameter bindings
         */
        public static function parents(OODBBean $bean, $sql = null, $bindings = [])
        {
...
namespace RedBeanPHP\Util {
    ...
    class DispenseHelper
    {
         ...
         *
         * @param bool $yesNo whether to enforce RB name policy
         *
         * @return void
         */
...
namespace RedBeanPHP\Util {
    ...
    class MatchUp
    {
         ...
         * @return mixed
         */
        public function matchUp($type, $sql, $bindings = [], $onFoundDo = null, $onNotFoundDo = null, &$bean = null)
        {
            ...
            if ($bean && $onFoundDo) {
                foreach ($onFoundDo as $property => $value) {
                    if (function_exists('is_callable') && is_callable($value)) {
                        $bean[$property] = call_user_func_array($value, [$bean]);
                    } else {
                        $bean[$property] = $value;
                    }
                }
...
namespace RedBeanPHP\Util {
    ...
    class Look
    {
         ...
         * @return string
         */
        public function look($sql, $bindings = [], $keys = ['selected', 'id', 'name'], $template = '<option %s value="%s">%s</option>', $filter = 'trim', $glue = '')
        {
            $adapter = $this->toolbox->getDatabaseAdapter();
            $lines = [];
            $rows = $adapter->get($sql, $bindings);
...
namespace RedBeanPHP\Util {
    ...
    class Diff
    {
         ...
         * @return array
         */
        public function diff($beans, $others, $filters = ['created', 'modified'], $format = '%s.%s.%s', $type = null)
        {
            $diff = [];
